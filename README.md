...
- 📸 **[Gemini 3.6 Flash Heritage Analyzer](./doc/16-Gemini-Heritage-Analyzer.md)**: Multimodal Gemini 3.6 Flash real-time AR scanner, Fastify parallel execution (`Promise.all`), daily quota tracking, Web Speech audio narration, and R2 backup storage.
